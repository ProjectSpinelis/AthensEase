...
public class ProperListCreation {
    ...
    private static List<String> userSelectedLocations = new ArrayList<>();
    private static List<AttractionDistance> filteredDistances = new ArrayList<>();
    private static Map<String, String> attractionsMap = new HashMap();
    ...
    public static void main2() throws Exception {
        ...
        userSelectedLocations = List.of("Ακρόπολη", "Μετέωρα", "Δελφοί");
    ...
    public static List<String> getUserSelectedLocations() {
        return userSelectedLocations;
    }

    public static List<AttractionDistance> getFilteredDistances() {
        return filteredDistances;
    }

    public static Map<String, String> getAttractionsMap() {
        return attractionsMap;
    }

    public static List<AttractionDistance> getFilteredDistances2() {
        List<AttractionDistance> filteredDistances2 = new ArrayList<>();
        for (AttractionDistance ad : ProperListCreation.getFilteredDistances()) {
            AttractionDistance ad2 = new AttractionDistance(ProperListCreation
            .getAttractionNameFromAddress(ad.origin, ProperListCreation.getAttractionsMap()), ProperListCreation
            .getAttractionNameFromAddress(ad.destination, ProperListCreation
            .getAttractionsMap()), ad.distance, ad.duration, ad.status);
            filteredDistances2.add(ad2);
        }
        return filteredDistances2;
    }
    ...
    public static class AttractionDistance {
